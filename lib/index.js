  ...
  return {
    Program: {
      enter: function enter() {
        ...
        this.oxygenStyle = { filename: filename, stylesheets: {}, declarations: 0 };
        context[KEY].visiting[filename] = true;
      },
      exit: function exit() {
        var filename = this.oxygenStyle.filename;
    ...
    CallExpression: function CallExpression(path) {
      ...
      (0, _assert2.default)(t.isVariableDeclarator(path.parentPath.node), 'return value of oxygenStyle(...) must be assigned to a variable');
      ...
      (0, _assert2.default)(expr, 'oxygenStyle(...) call is missing an argument');
