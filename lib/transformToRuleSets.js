...
var KeyframesDeclaration = function () {
  function KeyframesDeclaration(name, frames) {
    _classCallCheck(this, KeyframesDeclaration);
  ...
  _createClass(KeyframesDeclaration, [{
    key: 'store',
...
var CombinatorDeclaration = function (_NestedDeclaration4) {
  ...
  function CombinatorDeclaration(parent, combinatorSelector, rules) {
    ...
    if (!(0, _isHtmlTag2.default)(combinatorSelector)) {
      ...
      _this5.combinatorSelector = combinatorSelector.toLowerCase();
    }
    return _this5;
  }
...
function transformToRuleSets(obj, options, output) {
  ...
  Object.keys(obj).forEach(function (key) {
    ...
    if (isKeyframesDeclaration.test(key)) {
      var dec = new KeyframesDeclaration(key.substring(1), value);
      dec.toJson(output, options);
    } else if ((0, _isHtmlTag2.default)(key)) {
      var _dec = new TagDeclaration(null, key, value);
      _dec.toJson(output, options);
    } else {
      var _dec2 = new ClassDeclaration(null, key, value);
      _dec2.toJson(output, options);
    }
  });
}
