...
var ClassDeclaration = function (_NestedDeclaration2) {
  ...
  function ClassDeclaration(className, rules) {
    _classCallCheck(this, ClassDeclaration);

    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(ClassDeclaration).call(this, rules));
...
var CombinatorDeclaration = function (_NestedDeclaration3) {
  _inherits(CombinatorDeclaration, _NestedDeclaration3);

  function CombinatorDeclaration(parent, combinatorSelector, rules) {
    _classCallCheck(this, CombinatorDeclaration);

    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(CombinatorDeclaration).call(this, rules, parent));

    _this4.operand = ' ';
    _this4.pre = ' ';
    _this4.post = ' ';

    _this4.combinatorSelector = combinatorSelector;
    return _this4;
  }
  ...
  _createClass(CombinatorDeclaration, [{
    ...
    key: 'toJson',
    value: function toJson(output, options) {
      output.classMap[this.combinatorSelector] = (0, _generateClassName.generateClassName)(this.rules, this.combinatorSelector, options);
      this.process();
      this.store(output);
      this.combinators.forEach(function (combinator) {
        return combinator.toJson(output, options);
...
var PseudoCombinator = function (_CombinatorDeclaratio) {
  ...
  function PseudoCombinator() {
    ...
    return _ret = (_temp = (_this5 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PseudoCombinator)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this5), _this5.operand = '', _this5.pre = '', _this5.post = '', _temp), _possibleConstructorReturn(_this5, _ret);
  }
...
var DescendantCombinator = function (_CombinatorDeclaratio2) {
  ...
  function DescendantCombinator() {
    ...
    return _ret2 = (_temp2 = (_this6 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(DescendantCombinator)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this6), _this6.operand = ' ', _this6.pre = '', _this6.post = '', _temp2), _possibleConstructorReturn(_this6, _ret2);
  }
...
var AndCombinator = function (_CombinatorDeclaratio3) {
  ...
  function AndCombinator() {
    ...
    return _ret3 = (_temp3 = (_this7 = _possibleConstructorReturn(this, (_Object$getPrototypeO3 = Object.getPrototypeOf(AndCombinator)).call.apply(_Object$getPrototypeO3, [this].concat(args))), _this7), _this7.operand = '', _this7.pre = '', _this7.post = '', _temp3), _possibleConstructorReturn(_this7, _ret3);
  }
...
var ChildCombinator = function (_CombinatorDeclaratio4) {
  ...
  function ChildCombinator() {
    ...
    return _ret4 = (_temp4 = (_this8 = _possibleConstructorReturn(this, (_Object$getPrototypeO4 = Object.getPrototypeOf(ChildCombinator)).call.apply(_Object$getPrototypeO4, [this].concat(args))), _this8), _this8.operand = '>', _temp4), _possibleConstructorReturn(_this8, _ret4);
  }
...
var AdjacentSiblingCombinator = function (_CombinatorDeclaratio5) {
  ...
  function AdjacentSiblingCombinator() {
    ...
    return _ret5 = (_temp5 = (_this9 = _possibleConstructorReturn(this, (_Object$getPrototypeO5 = Object.getPrototypeOf(AdjacentSiblingCombinator)).call.apply(_Object$getPrototypeO5, [this].concat(args))), _this9), _this9.operand = '+', _temp5), _possibleConstructorReturn(_this9, _ret5);
  }
...
var SiblingCombinator = function (_CombinatorDeclaratio6) {
  ...
  function SiblingCombinator() {
    ...
    return _ret6 = (_temp6 = (_this10 = _possibleConstructorReturn(this, (_Object$getPrototypeO6 = Object.getPrototypeOf(SiblingCombinator)).call.apply(_Object$getPrototypeO6, [this].concat(args))), _this10), _this10.operand = '~', _temp6), _possibleConstructorReturn(_this10, _ret6);
  }
...
function transformToRuleSets(obj, options, output) {
  ...
  Object.keys(obj).forEach(function (className) {
    var dec = new ClassDeclaration(className, obj[className]);
